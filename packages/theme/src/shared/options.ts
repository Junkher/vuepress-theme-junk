...
export type JunkThemeLocaleOptions = JunkThemeData
...
export interface JunkThemeLocaleData extends LocaleData {
  ...
  /**
   * Jump to this link when you click the button of hero
   */
  entryLink?: string
   ...
   *
   * Used as the link of back-to-home logo
   */
  home?: string
